...
class GAT1(nn.Module):
    ...
    def __init__(self, n_feats, fp, dropout=0.2):
        ...
        self.gnn_layers = GAT(
            ...
            hidden_feats=[50, 50],
            num_heads=[4, 4],
            feat_drops=[dropout, dropout],  # dropout 값으로 대체
            attn_drops=[dropout, dropout],
            alphas=[dropout, dropout],
            residuals=[True, True],
        ...
        self.linear = nn.Sequential(
            ...
            nn.Dropout(dropout),  # dropout 값으로 대체
            nn.ReLU(),
            nn.BatchNorm1d(128),
            nn.Linear(128, 128),
            nn.ReLU()
...
class Mymodel(nn.Module):
    ...
    def __init__(self, n_feats, fp, dropout=0.2):
        ...
        self.GAT = GAT1(n_feats, fp, dropout=dropout)  # dropout 전달
